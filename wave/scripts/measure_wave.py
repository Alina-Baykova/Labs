...
plt.plot(np.array([2.4] * 200), np.linspace(-5, 140, 200), color = 'g', linestyle = '--', label = '2.1 с')
plt.plot(np.array([1.7] * 200), np.linspace(-5, 140, 200), color = 'orange', linestyle = '--', label = '1.8 с')
plt.plot(np.array([1.0] * 200), np.linspace(-5, 140, 200), color = 'b', linestyle = '--', label = '1.4 с')
plt.legend()
